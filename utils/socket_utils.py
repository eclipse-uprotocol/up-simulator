...
def start_service(entity, callback):
    if entity == "body.cabin_climate":
        from mockservices.cabin_climate import CabinClimateService
...
class SocketUtility:
    ...
    def execute_send_rpc(self, json_sendrpc):
        try:
            ...
            if status == '':
                ...
                data = json_sendrpc['data'].replace("123", "#")
    ...
    def execute_subscribe(self, json_subscribe):
        topic = json_subscribe['topic'].replace("123", "#")
        try:
